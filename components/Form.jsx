      ...
      >
        <div>
          ...
          <input
            type="text"
            id="name"
            className="w-full rounded-sm border-2 border-black shadow-xl py-2 placeholder:px-2"
            autoComplete="none"
        ...
        <div>
          ...
          <textarea
            id="des"
            className="w-full rounded-sm border-2 border-black shadow-xl py-2 placeholder:px-2 placeholder:align-middle"
            autoComplete="none"
